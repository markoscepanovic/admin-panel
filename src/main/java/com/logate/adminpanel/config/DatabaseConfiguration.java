package com.logate.adminpanel.config;

import com.logate.adminpanel.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.logate.adminpanel.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.logate.adminpanel.repository.search")
